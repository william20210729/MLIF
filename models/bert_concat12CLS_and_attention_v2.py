...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.fc = nn.Linear(config.hidden_size*( self.layercount), config.num_classes) ### 768, 5  修改第一个参数
    ...
    def forward(self, x):
        ...
        a = att
        b = a.view(context.shape[0] * ( self.layercount) * 768)  ##############
        c = b.reshape(context.shape[0], ( self.layercount)  * 768)
