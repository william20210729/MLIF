...
parser.add_argument('--model', type=str, default="bert_concat12CLS_v2", help='choose a model: Bert') #####
...
parser.add_argument('--file_suffix', type=str, default="", help='运行指定日期时间点划分的数据集；不指定的话默认为空') ##### _2024_03_25_14_12_50
...
if resplitdata == "1":
    ...
    file_suffix = "_" + time.strftime('%Y-%m-%d %H:%M:%S').replace("-","_").replace(":","_").replace(" ","_")
    print("data file_suffix updated ", file_suffix)
# file_suffix = "_2024_03_25_14_12_50"  # Test Loss:  0.22,  Test Acc: 92.42%
# file_suffix=""
